...
OUT = PROJECT / "03_CANDIDATES" / "master-smc-sats-nci-story-v0.1.2.pine"

NOTE = """// ══════════════════════════════════════════════════════════════════════════════
// MASTER SMC + SATS + NCI STORY CANDIDATE v0.1.2
// Base: existing SMC/SATS engine.
// Added: NCI story layer using strong supply/demand OB as main key levels.
